...
class CompanyDetailsItemSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        company_prices_intraday_list = response.xpath(
        ...
        for idx in range(0, count):
            ...
            details['company_name'] = company_name_list[idx]
            details['company_price_intraday'] = company_prices_intraday_list[idx]
            details['company_symbol'] = company_symbol_list[idx]
            details['company_symbol_link'] = url + company_symbol_link_list[idx]
